...
#define RS                     0.29 /* Stator resistance , ohm*/
#define LS                     0.000059 /* Stator inductance, H
...
#define NOMINAL_CURRENT         13077
#define MOTOR_MAX_SPEED_RPM     2346 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  2.4 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -13077 /*!< Demagnetization current */
